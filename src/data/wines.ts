...
export const WINES: Wine[] = [
  {
    ...
    priceEur: 28,
    summary:
      "The wine the family drinks. Made every year, and meant to be opened.",
    story: [
  ...
  },
  {
    ...
    priceEur: 64,
    summary:
      "The flagship. Thirty months in oak, then at least a year in bottle before it leaves.",
    story: [
  ...
  },
  {
    ...
    priceEur: 24,
    summary:
      "The estate’s only white. Picked early, pressed the same morning, never near oak.",
    story: [
  ...
  },
  {
    ...
    priceEur: 110,
    summary:
      "From the oldest part of the estate, where some vines are over sixty. Not made every year.",
    story: [
...
export function labelNumber(wine: Wine, bottle = 1842): string {
  const number = String(bottle).padStart(5, "0");
  return `Bottle ${number} of ${wine.bottles.toLocaleString("en-GB")}`;
}
