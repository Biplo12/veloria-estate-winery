...
export function Visit() {
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[86rem] px-6 pb-24 pt-32 sm:px-10 sm:pb-32 sm:pt-40 lg:pb-40">
        <div className="grid grid-cols-1 gap-y-14 lg:grid-cols-12 lg:items-end lg:gap-x-8">
          <div className="lg:col-span-6">
            ...
            <Reveal delay={90}>
              <p className="mt-7 max-w-[52ch] text-lg leading-[1.6] text-white sm:text-xl">
              ...
              <a
                href="#contacts"
                className="mt-10 inline-flex items-center bg-vine px-8 py-4 text-ink hover:bg-vine/85 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-vermilion"
              >
            ...
            <Reveal delay={180}>
              <ul className="grid grid-cols-1 gap-x-8 sm:grid-cols-2">
                {PLACES.map((place) => (
                  <li
                    key={place}
                    className="border-t border-vine/25 py-4 text-base leading-[1.6] text-white sm:text-lg"
                  >
                    {place}
                  </li>
                ))}
