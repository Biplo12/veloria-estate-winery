...
export default function Home() {
  return (
    <main className="relative flex h-[100svh] flex-col overflow-hidden bg-paper">
      <SiteHeader />

      <div className="relative flex w-full flex-1 flex-col">
        {/* The painting fills the screen exactly — never taller, never leaving a
            band of bare paper. `object-[50%_20%]` splits the overflow 20/80:
            four fifths comes off the flowering foreground, a deep repeating band
            that loses a strip without anyone noticing, and the last fifth lifts
            the estate out of its own empty sky. 20 is the ceiling — past it the
            treeline reaches the name at 1366 × 768, the tightest common window.
            On a phone the painting takes the lower half and the name sits above
            it, since a full-height crop there would narrow it to a slice. */}
